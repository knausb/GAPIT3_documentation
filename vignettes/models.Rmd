...
The **G**eneral **L**inear **M**odel (not to be confused with the generalized linear model)

$$
y = s_{i} + Q + \epsilon_{dnorm} 
$$
...
The **M**ixed **L**inear **M**odel


$$
y = s_{i} + Q + K + \epsilon_{dnorm} 
$$
...
**M**ultiple **L**oci **M**ixed **M**odel

$$
y = s_{i} + S + Q + K + \epsilon_{dnorm} 
$$
...
**Compressed MLM (CMLM)** individuals are replaced by groups determined by statistical clustering.
